...
import sty from "./PlasmicButton9.module.css"; // plasmic-import: L6pclz-kLVX1/css
...
export const PlasmicButton9__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButton9__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
function PlasmicButton9__RenderFunc(props) {
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ufuUj)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon10Icon
                className={classNames(projectcss.all, sty.svg__t7Nkj)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicButton9__ArgProps,
      internalVariantPropNames: PlasmicButton9__VariantProps
    });

    return PlasmicButton9__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButton9";
  } else {
    func.displayName = `PlasmicButton9.${nodeName}`;
  }
  return func;
}

export const PlasmicButton9 = Object.assign(
  // Top-level PlasmicButton9 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButton9
    internalVariantProps: PlasmicButton9__VariantProps,
    internalArgProps: PlasmicButton9__ArgProps,
    useBehavior
  }
);

export default PlasmicButton9;
/* prettier-ignore-end */
