...
import sty from "./PlasmicButton7.module.css"; // plasmic-import: 9i2eJ7zsVC-d/css
...
export const PlasmicButton7__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButton7__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bvi2H)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon10Icon
                className={classNames(projectcss.all, sty.svg__xguHy)}
                role={"img"}
              />
            ),
