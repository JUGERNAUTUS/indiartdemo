...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: IIz7Cb5qyfA/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__sQbXz)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___3QEcn)}
              />
            </React.Fragment>
          ),
