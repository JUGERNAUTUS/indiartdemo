...
import sty from "./PlasmicButton5.module.css"; // plasmic-import: O0lkQzv2d5iD/css
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__pmeDg)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon10Icon
                className={classNames(projectcss.all, sty.svg__upmcx)}
                role={"img"}
              />
            ),
