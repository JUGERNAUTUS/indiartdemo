...
import sty from "./PlasmicButton10.module.css"; // plasmic-import: NzLp13B_qM4h/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: aLtbJ-mOmkEW/icon
import Icon10Icon from "./icons/PlasmicIcon__Icon10"; // plasmic-import: XwzJQBZ6zjKG/icon

export const PlasmicButton10__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButton10__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
function PlasmicButton10__RenderFunc(props) {
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ypS9)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon10Icon
                className={classNames(projectcss.all, sty.svg__alUy)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicButton10__ArgProps,
      internalVariantPropNames: PlasmicButton10__VariantProps
    });

    return PlasmicButton10__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButton10";
  } else {
    func.displayName = `PlasmicButton10.${nodeName}`;
  }
  return func;
}

export const PlasmicButton10 = Object.assign(
  // Top-level PlasmicButton10 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButton10
    internalVariantProps: PlasmicButton10__VariantProps,
    internalArgProps: PlasmicButton10__ArgProps,
    useBehavior
  }
);

export default PlasmicButton10;
/* prettier-ignore-end */
